...
deploy:
	...
	ssh ${HOST} -p ${PORT} 'cd todo_${BUILD_NUMBER} && docker-compose run api-php-fpm php bin/console.php orm:generate-proxies'
	ssh ${HOST} -p ${PORT} 'cd todo_${BUILD_NUMBER} && docker-compose run api-php-cli php bin/console.php orm:generate-proxies'
